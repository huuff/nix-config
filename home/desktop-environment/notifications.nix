{ lib, ... }:
{
  ...
  services.swaync = {
    enable = true;
    # XXX: Copy-pasted from [ErikReider's config](https://github.com/ErikReider/Linux)
    # although I took it from an older commit at around November 2022, since I liked it the most
    # I've made a few changes to it, though

    # TODO: use stylix colors, opacity?
    style = lib.mkForce ''
