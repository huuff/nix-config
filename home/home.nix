{ pkgs, user, secrets, myModules, derivations, modules, scripts, ... }:
{
  ...
  programs.autorandr = {
    ...
    profiles = {
      portable = {
        fingerprint = {
          "eDP-1" = "";
        };
        config = {
          "eDP-1" = {
            enable = true;
